...
import GenCall from './genlayer-node/gen/gen_call.mdx'
import GenGetContractSchema from './genlayer-node/gen/gen_getContractSchema.mdx'
import GenGetTransactionReceipt from './genlayer-node/gen/gen_getTransactionReceipt.mdx'
import GenGetContractState from './genlayer-node/gen/gen_getContractState.mdx'

<GenCall />

<GenGetContractSchema />

<GenGetTransactionReceipt />
...
import GenDbgPing from './genlayer-node/debug/gen_dbg_ping.mdx'
import GenDbgTrie from './genlayer-node/debug/gen_dbg_trie.mdx'
