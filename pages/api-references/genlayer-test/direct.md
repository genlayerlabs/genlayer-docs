...
```python
vm.run_validator(leader_result: Any = <object object at 0x7f78ad4f8ac0>, leader_error: Optional[Exception] = None, index: int = -1)
```
...
| Parameter | Type | Required | Default |
|-----------|------|----------|---------|
| `leader_result` | `Any` | No | `<object object at 0x7f78ad4f8ac0>` |
