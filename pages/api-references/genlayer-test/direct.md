...
```python
vm.run_validator(leader_result: Any = <object object at 0x7fb830808ac0>, leader_error: Optional[Exception] = None, index: int = -1)
```
...
| Parameter | Type | Required | Default |
|-----------|------|----------|---------|
| `leader_result` | `Any` | No | `<object object at 0x7fb830808ac0>` |
