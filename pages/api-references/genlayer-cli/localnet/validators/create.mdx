...
| --- | --- | --- | :---: | --- |
|  |  | --stake &lt;stake&gt;        Stake amount for the validator (default: 1) (default: | No |  |
|  |  | "1") | No |  |
|  |  | --config &lt;config&gt;      Optional JSON configuration for the validator (e.g., | No |  |
|  |  | '\{"max_tokens": 500, "temperature": 0.75\}') | No |  |
