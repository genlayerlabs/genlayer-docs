...
- **Transaction submissions, satus changes and finalization:** Track the status and outcomes of submitted transactions.
...
You can view the node logs at the bottom of the GenLayer Simulator. This section automatically updates with new log entries as actions are performed within the simulator.
...
You can also filter the logs by message, content, transaction hash, as well as by categories.
