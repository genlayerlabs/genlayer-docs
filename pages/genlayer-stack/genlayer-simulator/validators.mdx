...
In the GenLayer Simulator, validators are essential for achieving consensus and validating transactions through a process known as [Optimistic Democracy](/core-concepts/optimistic-democracy). When you initialize the simulator based on your selected LLM provider(s), you are provided with 5 default validators.
