...
## Consensus Algorithm
The GenLayer Simulator does not implement the full Optimistic Democracy consensus. There is no change of leader or appeals process. The simulator focuses on providing a basic execution environment without the complexities of the full consensus mechanism.
