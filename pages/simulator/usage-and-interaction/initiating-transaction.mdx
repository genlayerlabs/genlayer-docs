...
2. After deploying your contract, In the Execute transaction section From the dropdown menu **Select a method**, choose the contract method you wish to execute.
...
4. Click on the **Execute Contract** button to send your request to the simulator. This will invoke the selected contract method with the provided arguments.
