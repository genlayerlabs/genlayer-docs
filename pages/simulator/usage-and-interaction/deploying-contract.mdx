...
1. Once you have load your Intelligent Contract, you will see the **Constructor Parameters** section on the left-hand pane. The constructor parameters are [automatically detected from your code if defined properly](#detecting-constructor-parameters).
