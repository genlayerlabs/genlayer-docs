...
3. Provide a JSON object that represents the contract’s default state. This step is crucial for contracts that require specific variables or settings at the start.
    ...
    ```
4. Once the contract is finalized and the default state is set, in the **Run and Debug** section click the **Deploy Intelligent Contract** button to compile and deploy your contract to the GenLayer simulator's blockchain.
