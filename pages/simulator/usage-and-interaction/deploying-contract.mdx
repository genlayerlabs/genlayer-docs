...
2. If you need to adjust your parameters, you can manually input them. Click on the **JSON** button to write the parameters in JSON format.

import Image from 'next/image'
 
<Image src="/manual-upload.png" alt="Node Log" width={700} height={700} />
