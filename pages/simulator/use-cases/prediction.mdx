...
<Image src="/prediction-resolve.png" alt="Execute Transactions" width={600} height={600} />
...
This process ensures that every game's outcome is processed correctly and consistently, maintaining the integrity of the prediction market. You can view the logs to see detailed information about the contract interaction. You can view the logs to see detailed information about the contract interaction.