...
The `EquivalencePrinciple` is ideal for contracts that involve complex operations, such as making multiple LLM calls or performing various tasks like data fetching and processing. This function gives you detailed control over how the outputs are validated. Depending on how you want the validators to work, you can choose between the **comparative** or **non-comparative** Equivalence principle options.
