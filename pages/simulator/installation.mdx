...
- **LLM Providers**: Sets up the selected LLM provider within Docker containers for running the validators
...
- **Frontend Interface**: aunches the simulator's frontend interface, accessible at http://localhost:8080/, where you can interact with and test your Intelligent Contracts.
