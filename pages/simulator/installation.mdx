...
the GenLayer CLI handles the download and setup of various Docker containers necessary for the environment. This process configures several system components required for executing and managing intelligent contracts. Here’s a breakdown of what the CLI is doing:
