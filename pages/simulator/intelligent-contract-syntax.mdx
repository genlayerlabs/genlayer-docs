...
<Callout type="info" emoji="ℹ️">
  In the `__init__` constructor method, you can execute any type of code(run any Python commands that you might use else where in your contract) and add any number of parameters as needed. Also, the names `initial_state` and `state_variable` used in the examples are placeholders. Feel free to rename these to better suit the context of your Intelligent Contract.
