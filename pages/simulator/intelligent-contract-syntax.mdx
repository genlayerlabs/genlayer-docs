...
<Callout type="info" emoji="ℹ️">
  Within the constructor of your intelligent contract, you have the flexibility to include any number of parameters and execute any type of code. The initial_state parameter and state_variable names provided here serve as examples. Feel free to define or customize these placeholders to suit the specific context of your intelligent contract.
</Callout>
