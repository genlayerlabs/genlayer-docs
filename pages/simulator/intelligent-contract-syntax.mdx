...
<Callout type="info" emoji="ℹ️">
 The `initial_state` parameter and `state_variable` name in this code are just placeholders and can be defined/customized to fit the context of your intelligent contract. 
</Callout>
