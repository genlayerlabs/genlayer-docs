...
2. **Override with your custom config** - Configure your `.env` and `config.yaml` files in the new installation, referring to your previous settings. Avoid directly copying these files, as new versions may include updated default configurations.
