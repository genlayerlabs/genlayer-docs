...
<Callout type="info" emoji="💡">
  For upgrades prior to <strong>v0.3.1</strong>, you can keep your existing validator node running while
...
`v0.3.1` introduces a new, fresh consensus deployment. For this reason, the validator must be set up from scratch without reusing the previous `data/genlayer.db` folder.
