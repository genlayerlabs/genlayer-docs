...
<Callout type="info" emoji="💡">
  To minimize downtime, you can keep your existing validator node running while you download and configure the new version according to the steps below. Once the new version is fully configured and ready to run, stop the old node and start the new one.
</Callout>
