# What is GenLayer?
GenLayer is a decentralized platform that introduces Intelligent Contracts—an advanced form of smart contracts that leverage AI to search the web, process natural language instructions, and achieve consensus on transactions. These contracts surpass traditional smart contracts by enabling real-time data interaction, non-deterministic execution, and seamless integration with AI, making them more versatile and dynamic for various applications.
...
- **Developer-Friendly**: GenLayer uses a Python, which simplifies the development of Intelligent Contracts.
