...
To navigate these docs, use the sidebar on the left. You can begin by exploring the [**GenLayer Protocol**](/understand-genlayer-protocol) to understand core concepts, or dive straight into [**Developer resources**](/developers) or [**Validator resources**](/validators).
