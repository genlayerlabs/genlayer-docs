...
In other words, GenLayer is the first Intelligent Blockchain, introducing smart contracts that are capable of natively accessing the internet and go beyond deterministic logic, to make subjective decisions. 
