---
breadcrumb: false
description: "GenLayer is the adjudication layer for the agentic economy: decentralized AI-validator consensus for contracts that require judgment, not just code."
---
