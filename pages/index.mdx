...
<Cards num={3}>
  <Card image title="YeagerAI" href="/partners/yeager">
    <div style={{ height: "150px", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "white", borderRadius: "8px" }}>
      <Image 
        src="/yeager.jpeg" 
        alt="YeagerAI" 
        fetchpriority="high" 
