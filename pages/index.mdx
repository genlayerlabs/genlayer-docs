...
In other words, GenLayer is the first Intelligent Blockchain capable of smart contracts that can natively access the Internet and go beyond deterministic logic to make subjective decisions. 
...
2. **Consensus-Backed Security** <br />
