...
Welcome to the GenLayer Getting Started Guide. This step-by-step tutorial will walk you through:

- Setting up your GenLayer environment
- Writing your first Intelligent Contract
- Deploying and interacting with your contract via the GenLayer Studio
- Creating end-to-end (e2e) tests with the genlayer-project-boilerplate
...
The GenLayer Studio is a browser-based IDE for developing, testing, and deploying Intelligent Contracts. You can access it at:
studio.genlayer.com

**Key Features:**
- **Code Editing:** Write and review Intelligent Contracts in a familiar environment.
- **One-Click Deployment:** Deploy contracts to your local environment or future networks.
- **Real-Time Logs & Debugging:** Inspect validator consensus, transaction statuses, and more.

## Local Installation of the GenLayer CLI

The GenLayer CLI helps you set up and manage your local GenLayer Studio instance. It will also support mainnet and testnet deployments as the protocol matures.
