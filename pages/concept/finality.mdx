### Finality and Finality Window in GenLayer

Finality and the Finality Window are integral parts of the Optimistic Democracy that ensures that transactions are thoroughly validated and disputes are resolved before becoming permanent.

## Finality in GenLayer
