...
The Equivalence Principle involves multiple validators randomly selected to determine whether different outputs from non-deterministic operations can be considered equivalent. One validator acts as the leader, proposing the output, while others validate it and then return it instead of their own computation
...
<Callout type="info" emoji="🏗️">
    This feature is in development. GenVM doesn't have interface for Non-Comparative Equivalence Principle right now
</Callout>
