...
Welcome to the GenLayer getting started guide. This guide will help you set up the GenLayer environment, write your first Intelligent Contract, deploy it, and interact with it using the GenLayer Studio. You'll also learn how to use the [genlayer-project-boilerplate](https://github.com/yeagerai/genlayer-project-boilerplate/) to write end-to-end tests and build a frontend dApp with GenLayerJS.

## Table of Contents
1. [Installation of the GenLayer CLI](#installation-of-the-genlayer-cli)
2. [Launching the GenLayer Studio](#launching-the-genlayer-studio)
