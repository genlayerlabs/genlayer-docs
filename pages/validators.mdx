...
1. Set up your account
   ...
   1. Create your account
      ...
      ```sh
      export password="your secret password" # Remember it! You will need it to unlock your account
   ...
   1. Set it as your current account

      ```sh
      yq -i '.wallet.validatorAddress = (.wallet.accounts | keys | .[0])' configs/node/wallet.yaml
      ```
...
1. Run
   ...
   1. Run the node
      ...
      ./bin/genlayernode run -c $(pwd)/configs/node/config.yaml --password ${password}
      ```
