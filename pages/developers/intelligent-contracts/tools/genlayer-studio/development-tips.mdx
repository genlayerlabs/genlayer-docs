---
description: "GenLayer Studio development tips explain validator setup, typed inputs, deployment, debugging, and transaction inspection."
---
import Image from 'next/image'

# Development Tips
GenLayer Studio development tips explain how to develop your Intelligent Contract, debug it, and test it in GenLayer Studio.
