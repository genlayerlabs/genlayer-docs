---
description: "Debug Intelligent Contracts interactively in GenLayer Studio: deploy, send transactions, validate behavior, and inspect node logs."
---

import { Callout } from 'nextra-theme-docs'

# Debugging Intelligent Contracts in GenLayer Studio
