...
<Cards>
  <Card title="🛠️ Tooling Setup" href="/developers/intelligent-contracts/tooling-setup" />
  ...
  <Card title="🔍 Testing and Debugging" href="/developers/intelligent-contracts/testing-and-debugging" />
  <Card title="✍️ Crafting Prompts" href="/developers/intelligent-contracts/crafting-prompts" />
  <Card title="⚡ Advanced Features" href="/developers/intelligent-contracts/advanced-features" />
  <Card title="🔒 Security and Best Practices" href="/developers/intelligent-contracts/security-and-best-practices" />
  <Card title="📚 Examples" href="/developers/intelligent-contracts/examples" />
</Cards>