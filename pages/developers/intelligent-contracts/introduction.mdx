---
description: "Intelligent Contracts are Python smart contracts on GenLayer that access the web and call LLMs natively, enabling judgment-based decisions on-chain."
---
