...
<Callout type="info">
  The syntax for sending to an EOA uses the EVM contract interface even though the recipient is not a contract. This will be simplified in a future version.
</Callout>
...
|---|---|
| Studio (Localnet) | Faucet button in the account selector UI |
