...
| **TestnetAsimov** | Pre-production testing | Final validation before mainnet |
...
<Cards>
  <Card 
    ...
    href="./deploying/deployment-methods"
  >
    Compare CLI vs Scripts approaches and choose the right method
  </Card>
  
  <Card 
    title="Best Practices" 
    href="./deploying/best-practices"
  >
    Follow proven practices for reliable, secure deployments
  </Card>
</Cards>
