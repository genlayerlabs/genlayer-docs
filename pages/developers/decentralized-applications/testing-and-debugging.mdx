...
# Testing and Debugging Intelligent Contracts on GenLayer

Testing and debugging Intelligent Contracts on GenLayer involves deploying contracts, sending transactions, validating their behavior, and identifying issues using logs. Here is some guidance on how to test and debug using the tools provided in the local development environment and GenLayer Studio.
